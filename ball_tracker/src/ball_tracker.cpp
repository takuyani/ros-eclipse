...
//	mSubImgRaw = mNh.subscribe(ros::names::remap(TOPIC_IN_IMAGE), 1, &BallTracker::callback_image, this);
	...
	ROS_INFO_STREAM("subscribe_camera_info: " + ros::names::remap(TOPIC_IN_CAMERA_INFO));
...
//	}
	...
	try {
		...
		cvImgPtr_RGB8 = cv_bridge::toCvCopy(aImg_cptr, sensor_msgs::image_encodings::BGR8);
		cvImgPtr_MONO8 = cv_bridge::toCvCopy(aImg_cptr, sensor_msgs::image_encodings::MONO8);
